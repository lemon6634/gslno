...
exports.run = (client, message, args) => {
    ...
    message.channel.send({ embeds: [embed.setDescription('**Espri yükleniyor** <:loading:980410754387816469>')] }).then(message => {
        ...
        message.edit({ embeds: [embed.setDescription(`${espri}`)] });
    });
}
exports.conf = {
    aliases: ['espri-yap', 'yap-espri', 'yapbi-espri', "espiri"]
};
exports.help = {
    name: 'espri',
